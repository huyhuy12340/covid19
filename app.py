...
region1 = df.groupby(['location']).max()
region2 = region1.groupby('continent').sum()
    ...
    children=[
        html.Div(
            children=[
                ...
                html.P('By: Huy Nguyen', className='header_sub')
            ],
            className = 'header'
        ),
        html.Div(
                                ...
                                children=[
                                        dcc.Graph(
                                            figure={
                                                ...
                                                'layout':
                                                {
                                                    "title": {"text": "New cases time series", 'text-align':'center'},
                                                    'plot_bgcolor': '181c27',
                    ...
                    html.Div(children=[
                             dcc.Graph(
                                            figure={
                                                ...
                                                'layout':
                                                {
                                                    "title": {"text": "Number of deaths within the last 7 days", 'text-align':'center'},
                                                    'plot_bgcolor': '181c27',
                                                    'paper_bgcolor' :'#181c27',
                                                    'font':{
                                                        'color':'#E1E2E2'
                    ...
                    html.Div(children=[
                        dcc.Graph(
                                        figure={
                                                ...
                                                'layout':
                                                {
                                                    "title": {"text": "Total case by region", 'text-align':'center'},
                                                    'plot_bgcolor': '#181c27',
                                                    'paper_bgcolor' :'#181c27',
                                                    'font':{
                                                        'color':'#E1E2E2',
